...
double kp[DOF_JOINTS] = { /// default p_gain
  ///root -> tip
  0.8,0.8,0.6,0.5, // index   
  0.8,0.8,0.6,0.5, // middle
  0.8,0.8,0.6,0.5, // pinky
  0.6,0.6,0.6,0.4  // thumb
};

double kd[DOF_JOINTS] = { /// default d_gain
  ///root -> tip
  0.05,0.05,0.04,0.04, // index
  0.05,0.05,0.04,0.04, // middle
  0.05,0.05,0.04,0.04, // pinky
  0.04,0.04,0.04,0.03  // thumb
};
