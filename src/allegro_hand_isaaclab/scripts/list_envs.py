...
All the environments are registered in the `v5_sense_isaaclab_pipeline` extension. They start
...
with contextlib.suppress(ImportError):
    import v5_sense_isaaclab_pipeline.tasks_experimental  # noqa: F401
...
def main():
    """Print all environments registered in `v5_sense_isaaclab_pipeline` extension."""
