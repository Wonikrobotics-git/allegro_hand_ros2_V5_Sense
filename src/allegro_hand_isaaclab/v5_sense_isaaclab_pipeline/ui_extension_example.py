...
def some_public_function(x: int):
    print("[v5_sense_isaaclab_pipeline] some_public_function was called with x: ", x)
    return x**x
...
class ExampleExtension(omni.ext.IExt):
    ...
    def on_startup(self, ext_id):
        print("[v5_sense_isaaclab_pipeline] startup")
    ...
    def on_shutdown(self):
        print("[v5_sense_isaaclab_pipeline] shutdown")
